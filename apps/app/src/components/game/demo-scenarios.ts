...
export const DEMO_SCENARIOS: DemoScenario[] = [
...

  {
    ...
    intro:
      "Тимур впервые на смене. Он не знает, как режется морковь под рагу, и стесняется переспрашивать. Правильный ход — показать, объяснить и договориться о короткой проверке.",
    employee: {
      name: "Тимур Асланов",
    ...
    script: [
      {
        role: "manager",
        text: "Тимур, сегодня твоя первая заготовка овощей. Начнём с моркови — нужны кубики по 5 миллиметров, пойдут в рагу.",
    ...
    evaluation: {
      ...
      outcome: {
        ...
        motivationDelta: 1,
        summary:
          "Тимур принёс первые 4 моркови на проверку, размер попал в норму. Дальше нарезал всю партию самостоятельно.",
      },
...

  {
    ...
    intro:
      "Тот же Тимур, та же морковь. Здесь руководитель делегирует, потому что «пусть учится сам». Для L1 это не свобода, а тупик — он не спросит и сделает не то.",
    employee: {
      name: "Тимур Асланов",
      role: "Стажёр · уровень L1",
      initials: "Т",
    ...
    script: [
      {
        role: "manager",
        text: "Тимур, там морковь надо на кубики — займись, ладно? На тебе.",
      ...
      },
      {
        ...
        note: "Обратная связь только по факту провала — и публично. Тимур потерял мотивацию.",
      },
    ],
    evaluation: {
      scorePercent: 22,
      ...
      outcome: {
        ...
        motivationDelta: -2,
        summary:
          "Заготовку пришлось переделывать, рагу для обеда задержалось. Тимур ушёл со смены угрюмый и стал избегать инициативы.",
      },
